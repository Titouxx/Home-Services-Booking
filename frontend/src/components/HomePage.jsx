                ...
                <>
                  ...
                  {matchingSubServices.map((sub) => (
                      <div
                          key={sub.id}
                          className={`service-card${
                              selectedService?.id === sub.id && selectedService?.isSubService
                                  ? " selected"
                                  : ""
                          }`}
                    ...
                    filteredBookings.map((b) => (
                        <div key={b.id} className="service-card">
                          <div>
                            ...
                            <p>
                              Date:{" "}
                              {new Date(b.appointmentDate).toLocaleDateString("fr-FR")} <br />
                              Time:{" "}
                    ...
                    filteredAvailabilities.map((a, i) => (
                        <div key={i} className="service-card">
                          <div>
                            ...
                            <p>
                              Date:{" "}
                              {new Date(a.availableDate).toLocaleDateString("fr-FR")} <br />
                              Time:{" "}
